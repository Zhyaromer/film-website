    ...
    return (
        <div className='bg-[#282e30]'>
            ...
            <div className='flex justify-end px-5'>
                <button onClick={() => fetchMovies()} className='mt-2 py-2 px-5 md:py-3 md:px-8 text-md md:text-lg font-semibold text-white bg-sky-500 rounded-lg cursor-pointer hover:bg-sky-600 transition-all duration-300 ease-in-out'>پێشنیاری ئێمە</button>
            </div>
